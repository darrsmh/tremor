// ================================================================
//  tls_certs.h — CA root for TLS verification
//
//  Root CA: GTS Root R1 (Google Trust Services LLC)
//  Expires : 2036-06-22
//  Validates the *.vercel.app chain (leaf ← WR1 ← GTS Root R1),
//  so the ESP32 verifies the server's certificate instead of
//  blindly accepting any server (setInsecure).
//  Extracted from the Google Trust Services PKI (pki.goog).
// ================================================================
#pragma once

#ifndef TLS_CA_ROOT_PEM
#define TLS_CA_ROOT_PEM \
"-----BEGIN CERTIFICATE-----\n" \
